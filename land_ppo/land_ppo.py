...
class AC(torch.nn.Module):
    def __init__(self):
        super().__init__()
        self.shared = torch.nn.Linear(8, 32)
        
        self.actor1 = torch.nn.Linear(32, 128)
        self.actor2 = torch.nn.Linear(128, 4)
        self.critic1 = torch.nn.Linear(32, 128)
        self.critic2 = torch.nn.Linear(128, 1)
...
def train(collection):
    for k in range(7):     
        ...
        com1 = torch.clamp(rt, 1-0.1, 1+0.1)*Advantages
        com2 = rt*Advantages
